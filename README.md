...
- Building autonomous AI agents with LangGraph & LangChain
- Implementing production RAG systems with vector databases
...
- **Skills**: Backend architecture, API design, database optimization, rate limiting
...
![ChromaDB](https://img.shields.io/badge/ChromaDB-FF6347?style=for-the-badge&logo=database&logoColor=white)
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=shahryar908&show_icons=true&theme=tokyonight&hide_border=true" alt="Shahryar's GitHub Stats" />
</p>

<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=shahryar908&theme=tokyonight&hide_border=true" alt="Shahryar's GitHub Streak" />
</p>

<p align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=shahryar908&layout=compact&theme=tokyonight&hide_border=true" alt="Top Languages" />
</p>

## 🎯 What I'm Building & Learning

### Current Focus Areas
- **Advanced RAG Architectures**: Hybrid search, query routing, self-RAG, RAPTOR
- **Agent Orchestration**: Multi-agent systems, tool creation, memory management with LangGraph
- **Production LLM Apps**: Streaming responses, context management, cost optimization
- **Vector DB Optimization**: Indexing strategies, similarity search, metadata filtering
- **Scalable Backend Design**: Microservices, async patterns, event-driven architecture
- **Kubernetes Deployments**: StatefulSets for databases, autoscaling ML services, Helm charts
- **AWS Infrastructure**: ECS/EKS for containers, Lambda for serverless functions, S3 for storage

### Recent Implementations
✅ Multi-agent RAG system with routing and validation  
✅ FastAPI backend with JWT auth, rate limiting, and WebSocket support  
✅ Docker containerization with multi-stage builds for GenAI apps  
✅ CI/CD pipeline with automated testing and deployment to AWS  
✅ Vector database integration with semantic caching  

### Next on Roadmap
🚀 Building production-grade LangGraph agents  
🚀 Implementing prompt caching and optimization strategies  
...
- Document chunking strategies & optimization
- Hybrid search (dense + sparse retrieval)
- Context window management & compression
- Query routing and self-RAG implementations
...
### Prompt Engineering
- Advanced prompting techniques (CoT, ReAct, Tree of Thoughts)
...
- **LangChain**: Agent types, tool creation, memory systems
...
### API Development
- FastAPI framework (async/await patterns)
...
### Database Management
- **PostgreSQL**: Complex queries, indexes, JSONB, full-text search
...
- Background tasks with Celery/Redis Queue
...
- Image registry management (Docker Hub, ECR)
...
### AWS Cloud Services
- **Compute**: EC2, ECS (Elastic Container Service), EKS, Lambda
- **Storage**: S3, EBS, EFS
...
- **Production-Ready Code**: Writing clean, maintainable, and scalable backend systems
- **GenAI Expertise**: Transforming LLM capabilities into real-world applications
- **DevOps Mindset**: Building with deployment, monitoring, and reliability in mind
